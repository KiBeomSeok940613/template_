...
const PageContent = styled.div`
    ...
    /* 크로스브라우징 때문에 그림자를 넣을땐 webkit */
    box-shadow: 0 15px 15px -10px rgba(0,0,0,1);
    text-align: center;
    h3{
        font-size: 165px;
        font-weight: bold;
        margin-bottom: 50px; color: #262626;
    }
    span{
        color: #00b7ff;
    }
    p{
        margin-bottom: 20px; font-weight: bold; font-size: 40px;
        span{
            color: red;
        }
    }
...
const Button = styled.button`
    background-color: #fff; border: 1px solid #ddd; padding: 10px 30px;
    border-radius: 5px; 
    cursor: pointer;
`
